...
export function renderHome(d) {
  ...
  const content = html`
      ...
      <div class="container hero__inner">
        ...
        <div class="hero__meta" data-reveal>
          <div class="hero__meta-item">
            ...
            <span class="hero__meta-key">сталь · Sigma / C / П</span>
          </div>
          <div class="hero__meta-item">
    ...
    ${raw(marquee(['Ангары', 'Склады и цеха', 'ЛСТК', 'Чёрный металл', 'Фермы и колонны', 'Зернохранилища', 'Плазменная резка', 'Раздел КМ', 'Полный цикл']))}
    ...
    <section class="section section--sheet" id="profiles">
      <div class="container">
        ${raw(sectionHead({
          ...
          text: 'Не «поколение» — а чертёж. Переключайте Sigma, C и П — сечение отрисуется прямо на листе, с размерными выносками как в разделе КМ.',
    ...
    <section class="section noise" id="factory">
      <div class="container">
        ...
        <div class="grid grid--3 factory__lists">
          ${[
            ['Линейка профилей', ['Sigma — профили повышенной жёсткости', 'C — несущие элементы', 'П — направляющие и усиления', 'Толщина — под расчётную нагрузку']],
